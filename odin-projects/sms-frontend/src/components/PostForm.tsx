...
const PostForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSuccessMessage('Post scheduled successfully!');
      setFormData({ content: '', scheduledDate: '', scheduledTime: '' });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200 flex items-center justify-center p-4">
      <form onSubmit={handleSubmit} className="bg-white shadow-2xl rounded-2xl p-8 max-w-md w-full space-y-6">
        <h2 className="text-3xl font-bold text-center text-indigo-600 mb-6">Schedule a Post</h2>
